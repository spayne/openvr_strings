...
//
// * (modified to call openvr_string::to_qstring instead of formatting directly) 
//
//==================================================================================================

#include "tracked_camera_openvr_sample.h"
#include "openvr_string_qstring.h"
...
void CQCameraPreviewImage::paintEvent( QPaintEvent *pEvent )
{
    ...
    painter.drawText( 0, nLabelY, contentsRect().width(), contentsRect().height(),
                      Qt::AlignRight|Qt::AlignTop,
                      QString( "Frame Size: %1x%2" ).arg( m_CurrentFrameHeader.nWidth ).arg( m_CurrentFrameHeader.nHeight ) );
    nLabelY += 20;
    ...
    painter.drawText( 0, nLabelY, contentsRect().width(), contentsRect().height(), Qt::AlignRight|Qt::AlignTop,
                      QString( "Pose: %1" ).arg( m_CurrentFrameHeader.standingTrackedDevicePose.bPoseIsValid ? "Valid" : "Invalid" ) );
    nLabelY += 20;
    ...
    painter.drawText(
            ...
            contentsRect().height(),
             Qt::AlignRight|Qt::AlignTop,
            openvr_string::to_qstring(*pMatrix));
    nLabelY += 60;
    ...
    painter.drawText(
            ...
            contentsRect().height(),
             Qt::AlignRight|Qt::AlignTop,
            openvr_string::to_qstring(*pVelocity));
    nLabelY += 30;
    ...
    vr::HmdVector3_t *pAngularVelocity = &m_CurrentFrameHeader.standingTrackedDevicePose.vAngularVelocity;
    painter.drawText(
            0,
            nLabelY,
            contentsRect().width(),
            contentsRect().height(),
             Qt::AlignRight|Qt::AlignTop,
            openvr_string::to_qstring(*pAngularVelocity) );
    nLabelY += 20;
}
...
bool CQTrackedCameraOpenVRTest::InitOpenVR()
{
    ...
    {
        LogMessage( LogError, "Failed to get tracked camera firmware description! (%s)\n", openvr_string::ETrackedPropertyErrorToString(propertyError));
        return false;
    }
